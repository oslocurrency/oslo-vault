# OsloVault Development

## Application Structure

- [OsloVault](https://github.com/oslocurrency/Nault) - The main wallet application (UI + Seed Generation/Block Signing/Etc).
...
```bash
git clone https://github.com/oslocurrency/OsloVault
cd OsloVault
npm install
```
